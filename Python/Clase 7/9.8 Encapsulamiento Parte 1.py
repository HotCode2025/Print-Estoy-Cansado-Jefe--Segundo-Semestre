class Persona:  # Creamos una clase
    ...
    def __init__(self, nombre, apellido, edad *args, **kwargs):  # Se lo llama método Init Dunder
        ...
        self._dni = dni_# Este atributo esta encapsulado de una manera sugerida
        self.edad = edad
        self.args = args
        self.wkargs = kwargs
...
persona3 = Persona('Rogelio', 'Romero', 35689456, 22, 'Telefono', '251444557', 'Calle Lopez', 823, 'Manzana', 77, 'Casa', 18, Altura= 1.83, Peso=105, CFavorito='Azul', Auto='Citroen', Modelo=2021)
